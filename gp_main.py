...
def score_func_basic(y, y_pred, sample_weight, other):  # 适应度函数：策略评价指标
    ...
    data_score = pos2value(data, data, stop_loss=0.096, stop_gain=105) # stop_loss=0.96, stop_gain=1.5
...
m = fitness.make_fitness(function=score_func_final,
...
# pop_num, gen_num,tour_num = 1000, 15, 100
# pop_num, gen_num,tour_num = 1000, 3, 20
# pop_num, gen_num, tour_num = 500, 5, 50
...
cmodel_gp = SymbolicRegressor(population_size=pop_num,  # 每一代公式群体中的公式数量 500，100
                              ...
                              function_set=(gp_delta, gp_signedpower, gp_decayl, gp_delayy,
